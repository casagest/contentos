...
function buildChecks() {
  ...
  const checks = [
    ...
    { name: "login_page", method: "GET", path: "/login", expectedStatuses: [200], warnMs: 1200, critMs: 3000 },
    { name: "register_page", method: "GET", path: "/register", expectedStatuses: [200], warnMs: 1200, critMs: 3000 },
    { name: "terms_page", method: "GET", path: "/terms", expectedStatuses: [200], warnMs: 1200, critMs: 3000 },
    { name: "privacy_page", method: "GET", path: "/privacy", expectedStatuses: [200], warnMs: 1200, critMs: 3000 },
    { name: "gdpr_page", method: "GET", path: "/gdpr", expectedStatuses: [200], warnMs: 1200, critMs: 3000 },
    {
      name: "dashboard_redirects",
      method: "GET",
      path: "/dashboard",
      expectedStatuses: [200],
      warnMs: 1500,
