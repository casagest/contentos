...
export const INDUSTRY_CONFIGS: Record<string, IndustryConfig> = {
  dental: {
    ...
    kpis: [
      ...
      { key: "revenue", label: "Revenue MTD (RON)", icon: "Euro", color: "#f59e0b", format: "currency", defaultValue: 0 },
  ...
  restaurant: {
    ...
    kpis: [
      ...
      { key: "revenue", label: "Revenue MTD (RON)", icon: "Euro", color: "#10b981", format: "currency", defaultValue: 0 },
