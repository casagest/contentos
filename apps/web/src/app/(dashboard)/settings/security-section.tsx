    ...
    <div className="rounded-xl bg-card border border-border p-6">
      ...
      <div className="space-y-3">
        <button
          ...
          className="w-full text-left p-3 rounded-lg bg-card hover:bg-muted transition text-sm text-gray-300 disabled:opacity-50 flex items-center gap-2"
        >
        ...
        {!deleteConfirm ? (
          <button
            ...
            className="w-full text-left p-3 rounded-lg bg-card hover:bg-red-500/5 transition text-sm text-red-400"
          >
            Sterge contul
          </button>
        ) : (
          <div className="p-3 rounded-lg bg-red-500/10 border border-red-500/20 space-y-3">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="px-4 py-2 rounded-lg bg-input text-gray-300 text-xs font-medium transition hover:bg-accent"
              >
                Anuleaza
              </button>
            </div>
