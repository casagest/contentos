...
function buildSystemPrompt(params: {
  ...
  return [
    ...
    "   a) NEVER invent ANY number: no '190 intervenții', no '95% satisfaction', no 'peste 500 pacienți' — unless that EXACT number appears in RAW_INPUT or BUSINESS_CONTEXT",
    "   b) NEVER invent doctor/staff names: no 'Dr. Paul', no 'Dr. Corpădean' — unless that EXACT name appears in RAW_INPUT or BUSINESS_CONTEXT",
    "   c) NEVER invent patient names, stories, or testimonials (e.g., 'Maria, 52 ani din Cluj')",
    "   d) NEVER fabricate awards, certifications, rankings, review counts, or prices",
    "   e) ONLY use facts that appear VERBATIM in RAW_INPUT, URL_CONTEXT, or BUSINESS_CONTEXT above",
    "   f) If data is missing, use GENERAL language: 'echipa noastră', 'experiență dovedită', 'rezultate vizibile' — NOT invented specifics",
    "   g) When in doubt: OMIT the claim. Generic but honest > specific but fabricated",
